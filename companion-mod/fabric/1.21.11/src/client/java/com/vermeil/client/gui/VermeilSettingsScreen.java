...
/**
 * In-game Vermeil settings screen (Minecraft 1.21.x) — the Fabric counterpart of
...
public class VermeilSettingsScreen extends Screen {
	...
	public void render(final GuiGraphics gfx, final int mouseX, final int mouseY, final float delta) {
		// The engine already drew the (blurred) background before calling render()
		// in 1.21.11 — calling renderBackground again double-blurs and crashes.
