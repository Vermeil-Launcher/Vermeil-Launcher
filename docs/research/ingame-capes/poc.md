...
## Where it lives
- Separate Gradle projects under `companion-mod/fabric/`, each folder named by the full MC range it covers (`26.1-26.2/`, `1.21-1.21.1/`, `1.21.2-1.21.4/`, …), outside the launcher's pnpm/cargo build.
